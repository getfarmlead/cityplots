            ...
            <Container>
                <Row>
                    ...
                    <video muted loop autoPlay className="img-fluid">
                            <source src="https://cityplots.000webhostapp.com/sale/cityVideo2.mp4" type="video/mp4" className="img-fluid"/>
                    </video>
        ...
        <div className="side_product_slider6" data-aos="fade-up">
            <Container>
                <Row className="align-items-center">
                    ...
                    <p>CityPlots stands out as a trailblazing AI-driven investment portal in the property sector, offering a revolutionary platform for those in pursuit of the perfect plot, land, or villa. With a commitment to redefining property ventures, CityPlots seamlessly merges decades of land preservation heritage with contemporary technology, ensuring a unique and flawless experience for every client. Prospective buyers can explore a diverse range of options, including CMDA-approved plots, premium villa plots, and DTCP-approved plots, tailored to their specific needs. This platform not only simplifies the property hunting experience but also ensures transparency and security in transactions, making it a go-to destination for those seeking perfect properties and plots for sale.</p>
                    </Col>
                    <Col>
                    <div className="banner_resize">
                        <img src={product_slider6} className="img-fluid" />
